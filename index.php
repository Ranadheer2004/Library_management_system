...
<html>
    ...
    font-weight: 600;
    color: white;
    background-color: #2C369D;
}

.login-form-3 h3 {
    text-align: center;
    color: Black;//Admin Login
}

.login-form-1 h3 {
    text-align: center;
    color: Black;//Student Login
}
.login-form-3 {
    padding: 5%;
    box-shadow: 0 5px 8px 0 rgba(10, 0, 50, 0.2), 0 9px 26px 0 rgba(0, 0, 0, 0.19);
    background-color: #184513;//Form background
}
.login-form-1 {
    background-color: grey;//Form background
}
...
<div class="b">
<div class="image"><div align=center><img src="images/1-7337.jpg "height="100px"</div>
