...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="CSE"/>CSE<div style="margin-left:80px"><input type="radio" name="branch" value="ECE"/>ECE<input type="radio" name="branch" value="EEE"/>EEE
            <input type="radio" name="branch" value="Civil"/>Civil<input type="radio" name="branch" value="Mechanical"/>Mechanical</div>
            </div>   
...
?>
            ...
            <p style="color:black"><u>Books Available:</u> &nbsp&nbsp<?php echo $bookava ?></p>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style=' 
            padding: 8px;'>Book Name</th><th>Price</th><th>Qnt</th><th>Available</th><th>Issued</th></th><th>View</th></tr>";
            foreach($recordset as $row){
                $table.="<tr>";
               "<td>$row[0]</td>";
                $table.="<td>$row[2]</td>";
